...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Items(ITEM_ID_RAT_TAIL, "Rat tail", "Rat tails"));
            Items.Add(new Items(ITEM_ID_PIECE_OF_FUR, "Piece of fur", "Pieces of fur"));
            Items.Add(new Items(ITEM_ID_SNAKE_FANG, "Snake fang", "Snake fangs"));
            Items.Add(new Items(ITEM_ID_SNAKESKIN, "Snakeskin", "Snakeskins"));
